...
INSERT INTO eventitask.section (board_id, name, color) VALUES
	(1, "Sprint IV", "bg-emerald-400"),
    (2, "Sprint IV", "bg-emerald-400"),
    (3, "Sprint IV", "bg-emerald-400");
    
INSERT INTO eventitask.task (section_id, name, description, priority, fibonacci, status, time, data_estimada) VALUES 
...
INSERT INTO eventitask.user_task VALUES
	(1, 1),
    (2, 2),
	(1, 2),
    (3, 3),
...
INSERT INTO eventitask.tag (name) VALUES 
	("front end"),
	("back end"),
    ("qa"),
    ("devops");

UPDATE eventitask.task SET STATUS = 1 WHERE id = 2;